namespace Tetris.Shapes
{
	class Z : Shape
	{
		public Z(System.Drawing.Point startLocation) : base(startLocation)
		{
			...
			States[ShapeState.Base] = new BlockType[,] { { BlockType.Empty, BlockType.Z, BlockType.Z, BlockType.Empty, BlockType.Empty },
			...
			States[ShapeState.DegreeRotation90] = new BlockType[,] { { BlockType.Empty, BlockType.Empty, BlockType.Empty, BlockType.Z, BlockType.Empty },
																	 { BlockType.Empty, BlockType.Empty, BlockType.Z, BlockType.Z, BlockType.Empty }, 
			...
			States[ShapeState.DegreeRotation270] = new BlockType[,] { { BlockType.Empty, BlockType.Empty, BlockType.Z, BlockType.Empty },
